package com.vaibhavpalande.takenotes;
...
import com.vaibhavpalande.takenotes.auth.Login;
import com.vaibhavpalande.takenotes.auth.Register;
import com.vaibhavpalande.takenotes.auth.Splash;
import com.vaibhavpalande.takenotes.model.Adapter;
import com.vaibhavpalande.takenotes.model.Note;
import com.vaibhavpalande.takenotes.note.AddNote;
import com.vaibhavpalande.takenotes.note.EditNote;
import com.vaibhavpalande.takenotes.note.NoteDetails;
...
//                Toast.makeText(this, "Msg", Toast.LENGTH_SHORT).show();
    ...
    private void checkUser() {
        //if user is real or not (Signed in with proper email and password)
        if(user.isAnonymous()){
            displayAlert();
        }else{
    ...
    private void displayAlert() {
        AlertDialog.Builder warning = new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Sync Notes Now", new DialogInterface.OnClickListener() {
                    ...
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        // Delete all the notes created by the Ano user
